...
import com.common.db.model.NewsModel;
...
/**
 * The base model implementation for the News service. Represents a row in the &quot;ats_News&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class NewsModelImpl extends BaseModelImpl<News> implements NewsModel {
	 ...
	 */
	public static final String TABLE_NAME = "ats_News";
	...
	public static final String TABLE_SQL_CREATE =
		"create table ats_News (uuid_ VARCHAR(75) null,id_ LONG not null primary key,userId LONG,title VARCHAR(75) null,subTitle VARCHAR(75) null,description VARCHAR(75) null,status INTEGER)";

	public static final String TABLE_SQL_DROP = "drop table ats_News";

	public static final String ORDER_BY_JPQL = " ORDER BY news.id ASC";

	public static final String ORDER_BY_SQL = " ORDER BY ats_News.id_ ASC";
	...
	static {
		...
		attributeGetterFunctions.put("uuid", News::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<News, String>)News::setUuid);
		attributeGetterFunctions.put("id", News::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<News, Long>)News::setId);
		attributeGetterFunctions.put("userId", News::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<News, Long>)News::setUserId);
		attributeGetterFunctions.put("title", News::getTitle);
		attributeSetterBiConsumers.put(
			"title", (BiConsumer<News, String>)News::setTitle);
		attributeGetterFunctions.put("subTitle", News::getSubTitle);
		attributeSetterBiConsumers.put(
			"subTitle", (BiConsumer<News, String>)News::setSubTitle);
		attributeGetterFunctions.put("description", News::getDescription);
		attributeSetterBiConsumers.put(
			"description", (BiConsumer<News, String>)News::setDescription);
		attributeGetterFunctions.put("status", News::getStatus);
		attributeSetterBiConsumers.put(
			"status", (BiConsumer<News, Integer>)News::setStatus);
	...
	public News cloneWithOriginalValues() {
		...
		newsImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		newsImpl.setId(this.<Long>getColumnOriginalValue("id_"));
		newsImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		newsImpl.setTitle(this.<String>getColumnOriginalValue("title"));
		newsImpl.setSubTitle(this.<String>getColumnOriginalValue("subTitle"));
		newsImpl.setDescription(
			this.<String>getColumnOriginalValue("description"));
		newsImpl.setStatus(this.<Integer>getColumnOriginalValue("status"));
