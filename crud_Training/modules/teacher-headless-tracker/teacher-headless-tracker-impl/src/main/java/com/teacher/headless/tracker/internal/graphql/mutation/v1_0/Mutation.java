package com.teacher.headless.tracker.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField(description = "add teacher")
	public TeacherEntry addTeacher(
			@GraphQLName("teacherEntry") TeacherEntry teacherEntry)
		throws Exception {

		return _applyComponentServiceObjects(
			_teacherEntryResourceComponentServiceObjects,
			this::_populateResourceContext,
			teacherEntryResource -> teacherEntryResource.addTeacher(
				teacherEntry));
	}

	@GraphQLField(description = "update teacher")
	public TeacherEntry updateTeacher(
			@GraphQLName("teacherEntry") TeacherEntry teacherEntry)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_teacherEntryResourceComponentServiceObjects,
			this::_populateResourceContext,
			teacherEntryResource -> teacherEntryResource.updateTeacher(
				teacherEntry));
	}

	@GraphQLField(description = "delete teacher")
	public TeacherEntry deleteTeacher(@GraphQLName("id") Long id)
		throws Exception {

		return _applyComponentServiceObjects(
			_teacherEntryResourceComponentServiceObjects,
			this::_populateResourceContext,
			teacherEntryResource -> teacherEntryResource.deleteTeacher(id));
	}
