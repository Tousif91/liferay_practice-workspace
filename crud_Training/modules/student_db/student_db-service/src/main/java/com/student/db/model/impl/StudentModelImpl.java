...
import com.student.db.model.StudentModel;
...
/**
 * The base model implementation for the Student service. Represents a row in the &quot;tr_Student&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "tr_Student";
	...
	public static final String TABLE_SQL_CREATE =
		"create table tr_Student (uuid_ VARCHAR(75) null,studentId LONG not null primary key,name VARCHAR(75) null,dob DATE null,gender VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table tr_Student";

	public static final String ORDER_BY_JPQL =
		" ORDER BY student.studentId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY tr_Student.studentId ASC";
	...
	public Student cloneWithOriginalValues() {
		...
		studentImpl.setDob(this.<Date>getColumnOriginalValue("dob"));
