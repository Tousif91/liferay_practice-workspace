...
import com.student.db.model.TeacherModel;
...
/**
 * The base model implementation for the Teacher service. Represents a row in the &quot;tr_Teacher&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TeacherModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "tr_Teacher";
	...
	public static final String TABLE_SQL_CREATE =
		"create table tr_Teacher (uuid_ VARCHAR(75) null,id_ LONG not null primary key,name VARCHAR(75) null,address VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table tr_Teacher";

	public static final String ORDER_BY_JPQL = " ORDER BY teacher.id ASC";

	public static final String ORDER_BY_SQL = " ORDER BY tr_Teacher.id_ ASC";
	...
	static {
		...
		attributeGetterFunctions.put("id", Teacher::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<Teacher, Long>)Teacher::setId);
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			0, Teacher.class.getName(), getPrimaryKey());
	}
	...
	public Teacher cloneWithOriginalValues() {
		...
		teacherImpl.setId(this.<Long>getColumnOriginalValue("id_"));
