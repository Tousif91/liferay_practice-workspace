 ...
 * <code>com.student.db.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.student.db.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Employee> findEmployeesByGender(String gender) {
		return getService().findEmployeesByGender(gender);
	}
	...
	public static List<Employee> getEmployeeByGender(String gender) {
		return getService().getEmployeeByGender(gender);
	}
