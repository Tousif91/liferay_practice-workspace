 ...
 * <code>com.student.db.service.impl.TeacherLocalServiceImpl</code> and
...
public class TeacherLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.student.db.service.impl.TeacherLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Teacher createTeacher(long id) {
		return getService().createTeacher(id);
	}
	 ...
	 */
	public static Teacher deleteTeacher(long id) throws PortalException {
		return getService().deleteTeacher(id);
	}
	...
	public static Teacher fetchTeacher(long id) {
		return getService().fetchTeacher(id);
	}
	 ...
	 * @throws PortalException if a teacher with the primary key could not be found
	 */
	public static Teacher getTeacher(long id) throws PortalException {
		return getService().getTeacher(id);
	}
