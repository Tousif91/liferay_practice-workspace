 ...
 * <code>com.student.db.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.student.db.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Student> findStudentByName(String name) {
		return getService().findStudentByName(name);
	}
