...
public interface TeacherLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.student.db.service.impl.TeacherLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the teacher local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TeacherLocalServiceUtil} if injection and service tracking are not available.
	 */
